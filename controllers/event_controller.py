...
from schemas.event_schema import EventsResponse, EventResponse, EventRequest, AttendanceRequest
from schemas.message_schema import MessageResponse
from services.event_service import EventService
from utils.auth_utility import get_current_user_id
...
async def set_attendance(
    ...
    await event_service.set_attendance(event_id, user_id, data.attending)
    return {"message": "Attendance updated"}
